...
const CheckoutForm = ({ order }) => {
    ...
    useEffect(() => {
        ...
        fetch(`${process.env.REACT_APP_API_BASE_URL}/create-payment-intent`, {
            ...
            body: JSON.stringify({  price:order?.orderProduct?.resalePrice }),
        })
            .then((res) => res.json())
    ...
    console.log(order?.orderProduct?.resalePrice)
    ...
    const handleSubmit = async (event) => {
        ...
        if (paymentIntent.status === "succeeded") {
            ...
            const payment = {
                price:order?.orderProduct?.resalePrice,
            ...
            fetch(`${process.env.REACT_APP_API_BASE_URL}/payments`, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
