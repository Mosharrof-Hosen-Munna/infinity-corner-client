    ...
    <div className=''>
          ...
          ">
                        ...
                        <div className="">
                            ...
                            <p className="mb-4">
                                <Link className="">Used Laptop</Link>
                            </p>
                            <p className="mb-4">
                                <Link className="">Macbook</Link>
                            </p>
                            <p className="mb-4">
                                <Link className="">Asus</Link>
                            </p>
                            <p>
                ...
                <div className="text-center p-6 bg-infinity text-white">
                    ...
                    <a className=" font-semibold" href="#_"> InfinityCorner</a>
                </div>
            </footer>
        </div>
  )
